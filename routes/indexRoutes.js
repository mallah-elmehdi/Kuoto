...
router
  ...
  .get(
    ...
    indexController.searchPage,
    errorController.globalErrorHandler
  )
  .post(
    authController.userLoggedIn,
    indexController.filter,
    errorController.globalErrorHandler
  );
...
router
  ...
  router
  .route("/envoyer-a-nouveau")
  .get(
    indexController.resend,
    errorController.globalErrorHandler
  );
